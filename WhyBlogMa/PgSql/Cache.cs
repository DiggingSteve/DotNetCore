...
namespace Infrastructure
{
    ...
    {
        public static CachePool CachePool = new CachePool();
    }
    public class CachePool
    {
        private static readonly MemoryCache Cache = new MemoryCache(new MemoryCacheOptions() { ExpirationScanFrequency = TimeSpan.FromSeconds(100) } );
